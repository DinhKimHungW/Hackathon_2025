...
export class InitialSchema1730577600000 implements MigrationInterface {
  name = 'InitialSchema1730577600000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Note: Actual table creation will be handled by TypeORM synchronize in development
    // For production, tables should be created explicitly in migration
